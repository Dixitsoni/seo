      ...
      <nav className="border-b border-surface-800/60 backdrop-blur-sm sticky top-0 z-50 bg-surface-950/80">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" aria-label="Go back home" className="text-surface-500 hover:text-surface-300 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid lg:grid-cols-[380px_1fr] gap-8">
          ...
          <aside className="space-y-5">
            ...
            {/* Word count */}
            <div>
              <label htmlFor="word-count" className="block text-xs font-semibold text-surface-400 uppercase tracking-wider mb-2">Target Word Count</label>
              <select
                id="word-count"
